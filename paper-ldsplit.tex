...
A description of the parameters of \texttt{snp\_ldsplit} implementing this method can be found in the supplementary materials.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.78\textwidth]{illu.png}
