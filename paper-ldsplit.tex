...
The problem that is solved here is to optimally split the genome into $K$ blocks, where each block has a bounded number of variants (minimum and maximum).
This splitting is optimal in the sense that it minimizes the sum of squared correlations between blocks.
