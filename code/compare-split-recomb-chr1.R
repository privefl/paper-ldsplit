...
res <- bigsnpr::snp_ldsplit(
  corr, thr_r2 = THR_R2, min_size = 200, max_size = 5000, max_K = n_block0)
...
levels(cut(recomb_map$pos, 10))
breaks <- c(0, 2.5, 5, 7.5, 10, 12.5, 15, 17.4, 19.9, 22.4, Inf) * 1e7

qplot(pos, bigutilsr::rollmean(rate, 50), geom = "line", data = recomb_map) +
  theme_bw(12) +
...
# ggsave("figures/compare_recomb_chr1.pdf", width = 11, height = 14)
